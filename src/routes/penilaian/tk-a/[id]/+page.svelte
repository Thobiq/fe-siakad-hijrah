  ...
  <div class="flex-1 flex flex-col overflow-hidden w-full">
    ...
    <header class="h-20 bg-white flex items-center justify-between px-6 md:px-10 shrink-0 border-b border-gray-100">
      <div class="flex items-center gap-4">
        ...
        <a href="/penilaian/tk-a" class="flex items-center gap-2 text-gray-500 hover:text-[#2da76b] font-semibold transition-colors">
      ...
      <div class="bg-white rounded-[30px] border border-gray-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] p-6 md:p-10 flex flex-col gap-8 max-w-5xl">
        ...
        <div class="flex flex-col gap-4">
          {#each daftarElemen as elemen}
            <a href="/penilaian/tk-a/{penilaianId}/{elemen.id}" class="w-full bg-[#33b679] text-white px-6 py-4 rounded-2xl font-bold text-lg text-left flex items-center gap-4 hover:bg-[#289562] transition-colors shadow-sm">
